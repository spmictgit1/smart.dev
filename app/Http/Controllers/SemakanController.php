...
class SemakanController extends Controller
{
   ...
   return view('semakan.semak',compact('status'));
    } 
...
// Validation passed, continue with your code     
  ...
  // dd($listsekolahpilihan_kaa);
     return view('semakan.hasilsemakan', compact('status','datamurid','notel_sek','listsekolahpilihan_kaa','listsekolahpilihan_sabk_dini','listsekolahpilihan_sabk_tahfiz','sekolahdirayu'));
    }
    else
      {
